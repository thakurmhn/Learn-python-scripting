...
def setup(iam_resource):
    ...
    """
    user = iam_resource.create_user(UserName=unique_name('s3-developer'))
    ...
    role = iam_resource.create_role(
        RoleName=unique_name('s3-Developer-Role'),
    ...
    policy = iam_resource.create_policy(
        PolicyName=unique_name('S3-ListBucket-Policy'),
    ...
    user.create_policy(
        PolicyName=unique_name('s3-Developer-AssumeRole-policy'),
        PolicyDocument=json.dumps({
            'Version': '2012-10-17',
            'Statement': [
                {
